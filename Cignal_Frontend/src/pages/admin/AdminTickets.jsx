      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
        <div className="flex flex-wrap items-center gap-3 mb-3">
          <div className="flex items-center gap-2 bg-slate-100 rounded-xl px-3 py-2 flex-1 max-w-xs">
            ...
            <input type="text" placeholder="Search subject, ID, category..." value={search}
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50">
                {["ID","Subject","Category","Priority","Status","Date","Actions"].map(h => (
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={7} className="py-10 text-center text-slate-400">Loading tickets...</td></tr>
              ) : filtered.length === 0 ? (
